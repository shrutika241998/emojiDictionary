...
const emojiWeKNow = Object.keys(emoji_dictionary);
const emojiValue = Object.values(emoji_dictionary);

export default function App() {
  const [meaning, setmeaning] = useState([]);
  const [emoji, setEmojiVal] = useState(emojiWeKNow);
  ...
  function emojiInputHandler(event) {
    ...
    let meaning = emoji_dictionary[userInput];
  ...
  function emojiSearchVal(e) {
    const emoji = Object.keys(emoji_dictionary).filter((key) =>
      emoji_dictionary[key].includes(e.target.value)
    );
    setEmojiVal(emoji);
  }
  ...
  const paginatedItems = emoji.slice(offset, offset + itemsPerPage);
    ...
    <div id="App">
      <div id="Body">
        ...
        <div className="searchSection">
          <label htmlFor="search">Search for emoji type by emotion</label>
          <input
            onChange={emojiSearchVal}
            placeholder="happy"
            id="search"
            ref={inputElement1}
          ></input>
        ...
        <div className="emoji">
          <ReactPaginate
            ...
            pageCount={Math.ceil(emoji.length / itemsPerPage)}
        ...
        <div className="flex flex-row items-center justify-center w-full">
          {paginatedItems.map(function (emoji) {
            return (
              <span
                className="emojiName"
                key={emoji}
